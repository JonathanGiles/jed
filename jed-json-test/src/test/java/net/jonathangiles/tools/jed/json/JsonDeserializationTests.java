...
import net.jonathangiles.tools.jed.json.model.Car;
import net.jonathangiles.tools.jed.json.model.Foo;
import net.jonathangiles.tools.jed.json.model.GenericFoo;
...
import net.jonathangiles.tools.jed.json.model.FooWithInner;
...
public abstract class JsonDeserializationTests {
    ...
    public void givenJsonHasNonMatchingFields_whenDeserializingWithCustomDeserializer_thenCorrect() {
        ...
        jsonApi.registerCustomDeserializer(new JsonDeserializer<Foo>(Foo.class) {
            @Override public Foo deserialize(JsonNode node) {
    ...
    public void customDeserializeCar() {
        ...
        jsonApi.registerCustomDeserializer(new JsonDeserializer<Car>(Car.class) {
            @Override public Car deserialize(JsonNode node) {
                Car car = new Car();
